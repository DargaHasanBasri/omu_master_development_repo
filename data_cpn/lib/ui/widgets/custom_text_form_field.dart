...
class CustomTextFormField extends StatelessWidget {
  const CustomTextFormField({
    ...
    this.isHaveObscure = false,
       ...
       textFieldBgColor = textFieldBgColor ?? ColorName.dark,
       textFieldTitle = textFieldTitle ?? '',
       hintText = hintText ?? '',
       prefixIconAddress = prefixIconAddress ?? 'assets/images/ic_sms.png',
       prefixIconColor = prefixIconColor ?? ColorName.darkGreyBlue,
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(borderRadius),
              borderSide: const BorderSide(color: ColorName.darkGreyBlue),
            ),
          ),
        ),
      ],
        ...
        children: [
          Text(
            ...
            style: Theme.of(context).textTheme.labelMedium?.copyWith(
              color: textFieldTitleColor ?? ColorName.white,
            ),
          ),
